...
import numpy as np
from lerobot_common_ros2.components.pose_stamped_subscription import (
    PoseStampedSubscriptionComponent,
)
...
class PoseStampedComponent(BaseComponent):
    ...
    def __init__(self, config: PoseStampedConfig):
        ...
        self._pose_stamped_subscription: PoseStampedSubscriptionComponent(self.config)

    def connect(self, node: Node) -> None:
        self.node = node

        self._pose_stamped_subscription.connect(self.node)
